...
| Système | Version                                                              |
| ------- | -------------------------------------------------------------------- |
| Android | _Oreo_ `8.0` (ou `6.0.1` si mise à jour de chrome possible à ≥ `60`) |
| iOS     | 11.3                                                                 |
...
Synapps Studio fonctionne sur _Windows 10_ et les versions suivantes.
