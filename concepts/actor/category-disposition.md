...
> ⚡ Chemin d'accès depuis l'acteur `properties.top`.
...
> ⚡ Chemin d'accès depuis l'acteur `properties.left`.
...
> ⚡ Chemin d'accès depuis l'acteur `properties.bottom`.
...
> ⚡ Chemin d'accès depuis l'acteur `properties.right`.
