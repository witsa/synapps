...
Le changement de style s'effectue par script. Consultez la [documentation de l'API Script](/synapps/script-api/) pour plus de détails.

La définition de style peut s'effectuer par script. Consultez la [documentation de l'API Script](/synapps/script-api/) pour plus de détails.
