...
{: .pin }
>
> Vous pouvez utiliser Synapps Studio avec des versions de REDY à partir de la `14.5.2`. Mais pour une expérience optimale, il est recommandé d'utiliser une version plus récente.
