---
title: Notes de version 1.6.1
nav_exclude: true
layout: minimal
---

# Notes de version `1.6.1`

## Révisions

> 2026-03-31T14:00:00

- ajout du runtime `2.8.1` de Synapps Runtime, disponible dans la version de REDY `16.4.2`

{% include table_of_content.html %}

## Synapps Runtime version 2.8.1

Support de la version `2.8.1` de Synapps Runtime, disponible dans la version de REDY `16.4.2`.

- Amélioration de l'aspect visuel de certains acteur de technique pour la chaufferie.
  - Acteur _Tuyau_ : les segments ont maintenant une bordure plus sombre pour mieux les différencier du fond ou les uns des autres une fois superposés.
  - Acteur _Bruleur_ : Il est possible de définir sa couleur avec la propriété _Couleur_.
  - Acteur _Chaudière_ : Il est possible de définir sa couleur avec la propriété _Couleur_.

Changements apportés dans la version `2.8.0` de Synapps Runtime disponible dans la version de REDY `16.4.0` :
...
| -------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reflet Ternaire      | _Tous_                                   | Le reflet _Digital_ est bien entendu le plus adapté. Mais tous les reflets peuvent être utilisés.                                                        |
| Reflet Bruleur       | _Bruleur_, _Digital_                     |                                                                                                                                                          |
| Reflet Chaudière     | _Chaudière_                              | Pour afficher la représentation de son bruleur, il faut que la sous-ressource correspondante existe et que le reflet _Bruleur_ ou _Digital_ soit activé. |
| Reflet Pompe simple  | _Pompe simple_, _Digital_                |                                                                                                                                                          |
| Reflet Pompe double  | _Pompe double_                           |                                                                                                                                                          |
| Reflet Vanne 2 voies | _Vanne 2 voies_, _Analogique_, _Digital_ |                                                                                                                                                          |
| Reflet Vanne 3 voies | _PID_, _Analogique_, _Digital_           |                                                                                                                                                          |
