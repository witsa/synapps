...
## Ajout du l'hôte actif dans la l'onglet d'exécution

L'onglet d'exécution de la synapp présente maintenant, comme le designer de scène, l'outil de selection de l'hôte actif.
...
Les changements par glissement de valeur n'entraine plus la création d'un grand nombre de modifications. 
...
L'arborescence du plan des acteurs s'ouvre automatiquement et présente l'acteur que l'on vient de sélectionner :

![auto-open-actor-demo](https://user-images.githubusercontent.com/35595723/131364818-d82bc3ec-2646-495f-9bd1-7f5eb7cd4ad6.gif)

Aussi, un défilement automatique se déclenche pour montre l'onglet, le composite, la scène ou l'acteur que l'on vient sélectionné.

## Evènements d'acteur suplémentaires

De nombreux évènements ont été ajoutés aux acteurs, notamment les évènements tactiles et de clavier :
...
Pour l'occasion, les éènements disponibles dans l'inspecteur d'acteur ont été réorganisés :
...
Les notes de version sont disponible dans le menu.

Elles s'affichent automatiquement au démarrage de Studio après avoir été mis à jour.

## Support du Runtime *v2.1.4*

- Les évènements suplémentaires.
