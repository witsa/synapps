...
Nouvel acteur qui permet d'aller chercher un reflet dans le REDY et de le mettre à disposition des autres acteurs.
...
> ℹ️ **Note**<br>
> Très pratique pour les reflets. Une fois le reflet sélectionné, les champs disponibles sont affichés. Si aucun reflet ne correspond, seul les champs communs à tous les relfets sont affichés.
...
Dans l'inspecteur, il est possible de copier le chemin d'une propriété ou d'une additionnelle. Cela se fait depuis le menu d'options de la propriété ou de l'additionnelle. Cela facilite l'écritre dans les scripts.
...
## Suivi de modification de clé d'acteur et de scène/composite
...
## Suivi de suppression d'additionnelle et d'acteur

Lorsqu'une additionnelle ou un acteur est supprimé, les liaisons qui les utilisent sont supprimées et les propriétés et additionnelles sont mis à zéro.

> ℹ️ **Note**<br>
> Il est possible de désactiver ce suivi au moment de la suppression en maintenant la touche `Alt` enfoncée pendant la demande de suppression.


## Amélioration des icones de laison
...
1view a été mis à jours en 1.0.6.
