---
title: Notes de version 1.7.3-beta
nav_exclude: true
layout: minimal
---

# Notes de version `1.7.3-beta`

## Révisions

> 1.7.3-beta - 2026-08-18T14:00:00

- Ajout de la possibilité de plier / déplier tous les dossiers de scènes dans l'explorateur de scènes.

> 1.7.3-beta - 2026-08-12T09:00:00

- Correction d'un soucis entre la multi-sélection et le designer de style

> 1.7.3-beta - 2026-08-10T12:00:00

- Multisélection mise à jour pour indiquer les acteurs sélectionnés dans la liste des acteurs de la scène.

> 1.7.3-beta - 2026-08-07T16:00:00

- Runtime version 2.9.3 supportée
- Mutliselection des acteurs dans une toile pour les manipuler simultanément (déplacement, disposition, suppression)

> 1.7.2 - 2026-07-28T12:00:00

- Amélioration de l'affichage du nombre de requêtes en cours dans les statistiques des previews.
- Correction d'une régression sur l'affichage des squelettes des acteurs dans les prévisualisations de scènes.

> 1.7.2 - 2026-07-15T12:00:00

- Optimisation des prévisualisations lorsqu'une scène a de très nombreux acteurs.

> 1.7.2 - 2026-07-09T17:00:00

- Correction du ralentissement de déplacement d'acteur dans une toile avec beaucoup d'acteurs.
...
- Ajout des acteur de _Barre de Navigation_ .
...
### Ralentissement de déplacement d'acteur

Lorsqu'on déplacait un acteur dans une toile dans une scène avec beaucoup plus d'acteurs qu'à l'habitude, le déplacement était très lent. Cela a été corrigé.
